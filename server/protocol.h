...
/*client 宏*/
/***********************************************************************/
#define REQ_EXIT           (unsigned short)0x0000 /*客户端发起的退出登陆请求*/

#define REQ_LOGIN          0x0001 /*客户端发起的登陆请求*/

#define REQ_ADD_USER       (unsigned short)0x0011 /*客户端发起的添加用户*/
#define REQ_DELETE_USER    (unsigned short)0x0012 /*客户端发起的删除用户*/
#define REQ_CHANGE_MSG     (unsigned short)0x0013 /*客户端发起的修改用户信息*/
#define REQ_SEARCH_MSG     (unsigned short)0x0014 /*客户端发起的管理员查询用户信息*/

#define REQ_USEARCH_MSG    (unsigned short)0x0021 /*客户端发起的用户查询用户信息*/
#define REQ_CHANGE_PASSWD  (unsigned short)0x0022 /*客户端发起的修改密码*/

#define RTL_WRONGPASSWD    (unsigned short)0x1000 /*密码错误*/
#define USER_LOGIN         (unsigned short)0x1001 /*用户模式*/
#define ROOT_LOGIN         (unsigned short)0x1002 /*管理员模式*/
